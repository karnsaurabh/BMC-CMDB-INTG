 ...
 *       &lt;sequence>
 *         &lt;element name="asset_class" type="{}ASCLType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DataLinesType {
    ...
    @XmlElement(name = "asset_class", required = true)
    protected List<ASCLType> assetClass;
     ...
     * 
     */
    public List<ASCLType> getAssetClass() {
        if (assetClass == null) {
            assetClass = new ArrayList<ASCLType>();
        }
