 ...
 *         &lt;element name="instanceInfo" type="{http://atrium.bmc.com/2009/01/instances/types}CreateInstanceInfoIn"/>
...
@XmlRootElement(name = "CreateInstance")
public class CreateInstance {
    ...
    @XmlElement(required = true)
    protected CreateInstanceInfoIn instanceInfo;
    @XmlElement(required = true, nillable = true)
     ...
     *     
     */
    public CreateInstanceInfoIn getInstanceInfo() {
        return instanceInfo;
    }
     ...
     *     
     */
    public void setInstanceInfo(CreateInstanceInfoIn value) {
