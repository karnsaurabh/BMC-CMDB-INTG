 ...
 *         &lt;element name="instanceInfo" type="{http://atrium.bmc.com/2009/01/instances/types}CreateInstanceInfoInList"/>
...
@XmlRootElement(name = "CreateMultipleInstances")
public class CreateMultipleInstances {
    ...
    @XmlElement(required = true)
    protected CreateInstanceInfoInList instanceInfo;
    @XmlElement(required = true, nillable = true)
     ...
     * @return
     *     possible object is
     *     {@link CreateInstanceInfoInList }
     *     
     */
    public CreateInstanceInfoInList getInstanceInfo() {
        return instanceInfo;
    }
     ...
     *     
     */
    public void setInstanceInfo(CreateInstanceInfoInList value) {
