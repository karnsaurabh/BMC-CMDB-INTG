 ...
 *         &lt;element name="instanceInfo" type="{http://atrium.bmc.com/2009/01/instances/types}SetInstanceInfoIn"/>
...
@XmlRootElement(name = "SetInstance")
public class SetInstance {
    ...
    @XmlElement(required = true)
    protected SetInstanceInfoIn instanceInfo;
    @XmlElement(required = true, nillable = true)
     ...
     *     
     */
    public SetInstanceInfoIn getInstanceInfo() {
        return instanceInfo;
    }
     ...
     *     
     */
    public void setInstanceInfo(SetInstanceInfoIn value) {
